...
ALTER TABLE dbo.PersonPhone
    ALTER COLUMN PhoneNumber Phone NOT NULL;
GO
ALTER TABLE dbo.PersonPhone
    ADD CONSTRAINT PK_PersonPhone_BusinessEntityID_PhoneNumber PRIMARY KEY (BusinessEntityID, PhoneNumber);
GO
...
ALTER TABLE dbo.PersonPhone
    ADD
        CONSTRAINT DF_PersonPhone_PostalCode DEFAULT '0' FOR PostalCode;
GO

-- 5
INSERT
    INTO dbo.PersonPhone
    (
         BusinessEntityID,
         PhoneNumber,
         PhoneNumberTypeID,
